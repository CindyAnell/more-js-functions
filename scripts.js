...
function addTheValues(param1, param2){
    if(isNaN(param1) || isNaN(param2)){
        addToPage ("One of the parameters is not a number. When added they equal: ") + (parseInt(param1) + " " + parseInt(param2));

    }else{
        addToPage("Both values are numbers. Added together they equal: ");
